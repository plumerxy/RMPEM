...
from utilities.utils_RE import preprocess_adj, adj_to_edge_index, load_real_dataset, get_graph_data
...
def load_ba2_ground_truth(shuffle=True):
    ...
    path = dir_path + '/data/BA-2motif/' + "BA-2motif" + '.pkl'
...
def load_mutag_ground_truth(shuffle=True):
    ...
    dir_path = os.path.abspath('.')
    path = dir_path + '/data/mutag_re/' + "Mutagenicity" + '.pkl'
    ...
    path = dir_path + '/data/mutag_re/' + '/Mutagenicity/Mutagenicity_'
